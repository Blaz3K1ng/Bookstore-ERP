...
class CustomerController extends Controller
{
    ...
    public function recordOrder(Request $request, int $id): JsonResponse
    {
        $v = Validator::make($request->all(), ['amount' => 'required|numeric|min:0']);
        ...
        $customer->increment('lifetime_value', $request->amount);
